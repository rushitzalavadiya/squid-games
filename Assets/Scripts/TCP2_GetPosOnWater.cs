...
public class TCP2_GetPosOnWater : MonoBehaviour
{
	...
	private float[] sinePosOffsetsX = new float[8]
	{
		1f,
		2.2f,
		2.7f,
	...
	private float[] sinePosOffsetsZ = new float[8]
	{
		0.6f,
		1.3f,
		3.1f,
	...
	private float[] sinePhsOffsetsX = new float[8]
	{
		1f,
		1.3f,
		0.7f,
	...
	private float[] sinePhsOffsetsZ = new float[8]
	{
		2.2f,
		0.4f,
		3.3f,
