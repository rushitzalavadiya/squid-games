...
namespace EpicToonFX
{
	public class ETFXButtonScript : MonoBehaviour
	{
		...
		public bool overButton()
		{
			...
			if (rect.Contains(new Vector2(UnityEngine.Input.mousePosition.x, (float)Screen.height - UnityEngine.Input.mousePosition.y)) || rect2.Contains(new Vector2(UnityEngine.Input.mousePosition.x, (float)Screen.height - UnityEngine.Input.mousePosition.y)))
			{
				return true;
			}
			return false;
